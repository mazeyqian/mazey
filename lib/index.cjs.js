...
function calLongestCommonSubSequence(aStr, bStr) {
  ...
  var arr1 = (_Array$prototype$conc = Array.prototype.concat).call.apply(_Array$prototype$conc, _toConsumableArray(arr)); // 获取最长公共子串


  var maxLong = Math.max.apply(Math, _toConsumableArray(arr1));
  return maxLong;
}
/**
 * @method join
...
function friendlyInterval() {
  var _ref7 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      start = _ref7.start,
      end = _ref7.end,
      _ref7$type = _ref7.type,
      type = _ref7$type === void 0 ? 'd' : _ref7$type;
