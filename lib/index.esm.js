...
var stringSlice$7 = functionUncurryThisRaw(''.slice);
 ...
 */
function friendlyInterval(start, end, options) {
  if (start === void 0) {
    start = 0;
  }
  if (end === void 0) {
...
function isNumber(num, options) {
  ...
  var _a = Object.assign({
    ...
    isNaNAsNumber = _a.isNaNAsNumber,
    isUnFiniteAsNumber = _a.isUnFiniteAsNumber;
  var ret = true;
  // 数字类型
...
function loadCSS(url, options) {
  ...
  var status = new Promise(function (resolve, reject) {
    var _a;
    _a = [resolve, reject], success = _a[0], _a[1];
  });
...
function getBrowserInfo() {
  try {
    ...
    var testVs = function testVs(regexp) {
      var matchRes = ua_1.match(regexp);
      var ret = '';
      if (matchRes) {
        ret = matchRes.toString().replace(/[^0-9|_.]/g, '').replace(/_/g, '.');
      }
      return ret;
    };
    // 系统
 ...
 * @returns {object} 新实例
 */
function genCustomConsole(prefix, options) {
  if (prefix === void 0) {
    prefix = '';
  }
  if (options === void 0) {
  ...
  var _a = Object.assign({
    ...
    isClosed = _a.isClosed,
    showWrap = _a.showWrap,
    showDate = _a.showDate,
    locales = _a.locales,
    logFn = _a.logFn,
    errorFn = _a.errorFn;
  ...
  var formatDate = function formatDate() {
    ...
    var todayDateIns = new Date();
    // https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/toLocaleDateString
    // https://datatracker.ietf.org/doc/html/rfc4647
    var dateStr = todayDateIns.toLocaleDateString(locales, dateOptions);
    return dateStr;
  };
  // if (showDate) {
  ...
  methods.forEach(function (method) {
    newConsole[method] = function () {
      ...
      var elaboratePrefix = prefix;
      var datePrefix = prefix;
      ...
      if (prefix || showDate) {
        (_a = console)[method].apply(_a, __spreadArrays([datePrefix], argu));
      } else {
 ...
 */
function zAxiosIsValidRes(res, options) {
  if (options === void 0) {
    options = {
  ...
  var _a = Object.assign({
    ...
    validStatusRange = _a.validStatusRange,
    validCode = _a.validCode;
...
function getFileSize(size) {
  var toCeilStr = function toCeilStr(n) {
...
export { addClass, addStyle, calLongestCommonSubsequence, calLongestCommonSubstring, camelCase2Underscore, camelCaseToKebabCase, cancelBubble, clearHtml, cutCHSString, debounce, deepCopyObject, doFn, floatFixed, floatToPercent, friendlyInterval, genCustomConsole, genHashCode, generateRndNum, generateUniqueNum, getBrowserInfo, getCookie, getDomain, getFileSize, getHashQueryParam, getLocalStorage, getPerformance, getQueryParam, getSessionStorage, getUrlParam, hasClass, inRate, isJsonString, isNonEmptyArray, isNumber, isSafePWAEnv, isSupportWebp, loadCSS, loadScript, mNow, mTrim, newLine, removeClass, setCookie, setLocalStorage, setSessionStorage, throttle, updateQueryParam, windowLoaded, zAxiosIsValidRes };
