...
exports.loadScript = exports.loadCSS = exports.getLocalStorage = exports.setLocalStorage = exports.getSessionStorage = exports.setSessionStorage = exports.doFn = exports.getQueryParam = exports.getSearchQueryParam = exports.getUrlParam = exports.isJsonString = exports.updateQueryStringParameter = exports.isNumber = exports.friendlyInterval = exports.debounce = exports.throttle = exports.removeClass = exports.addClass = exports.hasClass = exports.cancelBubble = exports.compatibleExist = exports.floatFixed = exports.floatToPercent = exports.resetForm = exports.generateUniqueNum = exports.generateRndNum = exports.deepCopyObject = exports.newLine = exports.trim = exports.getDomain = exports.camelCaseToKebabCase = exports.getHashQueryParam = exports.renderTable = exports.join = exports.calLongestCommonSubSequence = exports.calLongestCommonSubsequence = exports.calLongestCommonSubstring = void 0;
var common_1 = require("../service/common");
/**
...
function generateUniqueNum(n) {
    var _a = [common_1.mNow(), generateRndNum(n || 3)], now = _a[0], rnd = _a[1];
    return now + rnd;
}
...
function throttle(func, wait, options) {
    ...
    // previous: 上次时间戳
    var _a = [null, null, null, null, 0], context = _a[0], args = _a[1], result = _a[2], timeout = _a[3], previous = _a[4];
    if (!options) {
        options = {};
    }
    var later = function () {
        previous = options.leading === false ? 0 : common_1.mNow();
        timeout = null;
...
function debounce(func, wait, immediate) {
    var _a = [null, null, null, null, null], timeout = _a[0], args = _a[1], context = _a[2], timestamp = _a[3], result = _a[4];
    var later = function () {
        var last = common_1.mNow() - timestamp;
        if (last < wait && last >= 0) {
 ...
 */
function loadCSS(_a) {
    var url = _a.url, callback = _a.callback, id = _a.id;
